...
Generate content for section `section-02-kalshi-client` (filename: `section-02-kalshi-client.md`).
...
for `section-02-kalshi-client` to understand what this section should contain.
...
`/Users/mitch_tango/Library/CloudStorage/Dropbox-NewCity/Maitland Thompson/Working/EV/pga-ev-betting/planning/kalshi-integration/sections/section-02-kalshi-client.md`

...
Generate content for section `section-07-edge-deadheat` (filename: `section-07-edge-deadheat.md`).
...
for `section-07-edge-deadheat` to understand what this section should contain.
...
`/Users/mitch_tango/Library/CloudStorage/Dropbox-NewCity/Maitland Thompson/Working/EV/pga-ev-betting/planning/kalshi-integration/sections/section-07-edge-deadheat.md`

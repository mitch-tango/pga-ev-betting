...
Generate content for section `section-03-config-schema` (filename: `section-03-config-schema.md`).
...
for `section-03-config-schema` to understand what this section should contain.
...
`/Users/mitch_tango/Library/CloudStorage/Dropbox-NewCity/Maitland Thompson/Working/EV/pga-ev-betting/planning/kalshi-integration/sections/section-03-config-schema.md`

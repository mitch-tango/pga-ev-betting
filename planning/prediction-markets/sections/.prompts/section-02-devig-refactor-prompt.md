...
Generate content for section `section-02-devig-refactor` (filename: `section-02-devig-refactor.md`).
...
for `section-02-devig-refactor` to understand what this section should contain.
...
`/Users/mitch_tango/Library/CloudStorage/Dropbox-NewCity/Maitland Thompson/Working/EV/pga-ev-betting/planning/prediction-markets/sections/section-02-devig-refactor.md`

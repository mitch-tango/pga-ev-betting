...
Generate content for section `section-07-prophetx-client` (filename: `section-07-prophetx-client.md`).
...
for `section-07-prophetx-client` to understand what this section should contain.
...
`/Users/mitch_tango/Library/CloudStorage/Dropbox-NewCity/Maitland Thompson/Working/EV/pga-ev-betting/planning/prediction-markets/sections/section-07-prophetx-client.md`

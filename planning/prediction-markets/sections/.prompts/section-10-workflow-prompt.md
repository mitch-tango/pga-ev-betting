...
Generate content for section `section-10-workflow` (filename: `section-10-workflow.md`).
...
for `section-10-workflow` to understand what this section should contain.
...
`/Users/mitch_tango/Library/CloudStorage/Dropbox-NewCity/Maitland Thompson/Working/EV/pga-ev-betting/planning/prediction-markets/sections/section-10-workflow.md`

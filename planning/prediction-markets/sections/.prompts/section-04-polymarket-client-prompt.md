...
Generate content for section `section-04-polymarket-client` (filename: `section-04-polymarket-client.md`).
...
for `section-04-polymarket-client` to understand what this section should contain.
...
`/Users/mitch_tango/Library/CloudStorage/Dropbox-NewCity/Maitland Thompson/Working/EV/pga-ev-betting/planning/prediction-markets/sections/section-04-polymarket-client.md`
